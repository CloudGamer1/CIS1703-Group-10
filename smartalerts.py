...
from product_classes import Product, PerishableProduct
...
# sample for testing
# inventory = [
#    PerishableProduct("1", "Milk", 1.50, 2, "2026-05-01", 5),
#    PerishableProduct("2", "Cheese", 2.00, 10, "2026-05-03", 5),
...
#    new_item = PerishableProduct("4", "Yogurt", 1.20, 1, "2026-05-02", 5)
...
# buttons
# tk.Button(
#    root2, text="Run Smart Alerts", command=lambda: run_smart_alerts(inventory)
# ).pack(pady=10)

# testing sample
# tk.Button(root2, text="Add Test Product", command=add_dummy_product).pack(pady=10)
# root2.mainloop()
